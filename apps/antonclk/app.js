...
"To the choirmaster. Of the Sons of Korah. According to Alamoth. A Song.  God is our refuge and strength, a very present help in trouble. (Psa 46:1)",
...
"Beth  How can a young man keep his way pure? By guarding it according to your word.   I have stored up your word in my heart, that I might not sin against you. (Psa 119:11)",
"Nun  Your word is a lamp to my feet and a light to my path. (Psa 119:105)",
...
"that the man of God may be complete, equipped for every good work. (2Ti 3:17)",
...
"Behold, I am coming soon, bringing my recompense with me, to repay each one for what he has done. (Rev 22:12)"
  ...
  let draw = function() {
    ...
    g.setFontAlign(0, -1).setFont("7x11Numeric7Seg", 3).drawString(timeStr, 75, 30);
    ...
    g.drawString(formattedSeconds, 140, 33);

    // Draw day of month
    const dayOfMonth = date.getDate();
    const formattedDayOfMonth = dayOfMonth < 10 ? "0" + dayOfMonth : dayOfMonth;
    g.drawString(formattedDayOfMonth, 140, 50);
